...
% First bielliptic burn
rb = 9392.77;
a_t1 = (rb + a1 * (1 - e1)) / 2;
e_t1 = (rb - a1 * (1 - e1)) / 2 / a_t1;
OM_t1 = OM1;
om_t1 = om1;
i_t1 = i1;
th_t1 = 0;
[dv_b1, dv_b4, dv_b5, th_f, ~] = bielliptic_changeOrbitShape(a1, e1, om2, a2, e2, om2, rb, mu, 1);
...
% Anomaly of pericentre maneuver
[dv_b3, om_t3, th_t3] = changePeriapsisArg(a_t2, e_t2, om_t2, om2 - om_t2, mu, 1);
OM_t3 = OM_t2;
i_t3 = i_t2;
a_t3 = a_t2;
e_t3 = e_t2;

% Second bielliptic transfer orbit
a_t4 = (a2 * (1 - e2) + a_t3 * (1 + e_t3)) / 2;
e_t4 = (-a2 * (1 - e2) + a_t3 * (1 + e_t3)) / 2 / a_t4;
OM_t4 = OM2;
om_t4 = om2;
i_t4 = i2;
...
[X_t1, Y_t1, Z_t1] = plotOrbit([a_t1, e_t1, i_t1, OM_t1, om_t1, th_t1], mu, th_t2, pi/100);
[X_t2, Y_t2, Z_t2] = plotOrbit([a_t2, e_t2, i_t2, OM_t2, om_t2, th_t2], mu, -(om_t2 -om_t3)/2 - th_t2, pi/100);
[X_t3, Y_t3, Z_t3] = plotOrbit([a_t3, e_t3, i_t3, OM_t3, om_t3, (om_t2 - om_t3)/2], mu, pi - (om_t2 - om_t3)/2, pi/100);
...
plot3(X_t4, Y_t4, Z_t4, 'y', 'LineWidth', 1)
...
plot3(X_t4(1), Y_t4(1), Z_t4(1), 'xy', 'LineWidth', 2)
