% Alternative transfer N°5 - Lambert's transfer
% The transfer consists of the following maneuvers:
% 1. First impulsive maneuver at starting point.
% 2. Second impulsive maneuver at end point.
% Total dv = 3.4795 km/S
% Total time = 6922.2 s
% Remarks:
% i. Between the infinitude of transfer orbits connecting the two points,
% those that would result in the satellite intersecting the Earth's surface
% were excluded.
% ii. The proposed solution is the orbit that minimizes the total delta-v
% cost of the transfer by using the function direct_optimal_transfer.m.
clear all
...
[a_t, e_t, i_t, OM_t, om_t, th_t1, th_t2, dv_tot] = direct_optimal_transfer([a1, e1, i1, OM1, om1, th1], [a2, e2, i2, OM2, om2, th2]);
...
% Time for the satellite to transfer betwen the end points
T = timeOfFlight(a_t, e_t, th_t1, th_t2)
dv_tot
...
figure('Name','Alternative Transfer N5', 'NumberTitle', 'Off') 
set(gcf,'color','w');
Terra3d;
...
axis equal
box off
title('\fontsize{15}{0}\selectfont Alternative Transfer N5','Interpreter','latex')
